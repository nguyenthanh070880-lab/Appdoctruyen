...
public class CreateStoryFrame extends JFrame {
    ...
    private void saveStory() {
        ...
        if (title.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập tên truyện!", "Lỗi", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Lỗi khi thêm truyện: " + e.getMessage(),
